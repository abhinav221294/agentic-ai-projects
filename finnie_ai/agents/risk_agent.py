...
def risk_agent(state: AgentState) -> AgentState:
    ...
    canonical_risk = profile.get("risk")
    ...
    use_profile_risk = (
    canonical_risk is not None
    and profile.get("goal") is not None
    and profile.get("investment_type") is not None
    )
    print("use_profile_risk ",use_profile_risk)
    # -------------------------
    ...
    if use_profile_risk:
        ...
        "low": (
            "These investments focus on stability "
            "and lower volatility."
        ),

        "medium": (
            "These investments balance growth "
            "and stability."
        ),

        "high": (
            "These investments target higher "
            "long-term growth with higher volatility."
        )
        }

        explanation = explanation_map.get(
        canonical_risk,
        "Investment risk depends on market conditions."
        )
